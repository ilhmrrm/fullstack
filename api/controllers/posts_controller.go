...
import (
	...
	"github.com/ilhmrrm/fullstack/api/auth"
	"github.com/ilhmrrm/fullstack/api/models"
	"github.com/ilhmrrm/fullstack/api/responses"
	"github.com/ilhmrrm/fullstack/api/utils/formaterror"
)
...
func (server *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	postUpdate.ID = post.ID // IMPORTANT to tell the model the post ID to update, the other update field are set above
...
func (server *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	// check validity post id given to us
	pid, err := strconv.ParseUint(vars["id"], 10, 64)
	if err != nil {
		responses.ERROR(w, http.StatusBadRequest, err)
		return
	...
	// THe authenticated user, the owner of this post?
	if uid != post.AuthorID {
		responses.ERROR(w, http.StatusUnauthorized, errors.New("Unauthorized"))
		return
	}
